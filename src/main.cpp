...
//unsigned int nStakeMinAge = 60;	// minimum age for coin age: 8h
...
int64 nChainStartTime = 1399878075;
...
static const int64 nMinSubsidy = MIN_TXOUT_AMOUNT;
static const int CUTOFF_HEIGHT = 5720;	// End coin production at 1440, keep PoW at minimum coin reward till 5720 for safety, go full POS. this is just here for reference... we use POW_CUTOFF_HEIGHT later.
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if (nHeight == 1)
    {
        nSubsidy = 618 * COIN;       // first block is the entire mining of coin, minus 1439 coins I'm going to use to confirm this block.
    }
    else if ( nHeight <= 1441)
    {
            nSubsidy =  38 * COIN;      // these 1440 blocks are to confirm the first block. After this POW is cutoff in the CBlock:: code.
    }
...
static const int64 nTargetTimespan = 60 * 10;
//static const int64 nTargetTimespan = 60 * 30;
...
unsigned int GetNextTargetRequired(const CBlockIndex* pindexLast, bool fProofOfStake) 
{
    ...
    if (fProofOfStake || pindexLast->nHeight > 5740)
    {
...
bool CTransaction::GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const
{
    ...
    CBigNum bnCoinDay = bnCentSecond * CENT / COIN / (24 * 60 * 60); //(30*60); //(24 * 60 * 60);
    if (fDebug && GetBoolArg("-printcoinage"))
...
bool CBlock::AcceptBlock()
{
    ...
    // End POW after we mine block 1720
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "May 12 2014 Inside the Strange New World of DIY Brain Stimulation and also DickButt";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xef2754c1edd88ee7d69d09d9939cebf79155d7516d02a2d6b0eb6059efcaaafb"));
...
unsigned char pchMessageStart[4] = { 0xde, 0xd1, 0xeb, 0xf2 };
